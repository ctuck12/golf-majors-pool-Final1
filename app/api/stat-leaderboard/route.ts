...
const statDefs: Array<{ key: string; espnName: string; isPercent?: boolean; decimals?: number; altMultiplier?: number }> = [
  { key: 'drivingDistance', espnName: 'driveDistAvg', isPercent: false, decimals: 2 },
  { key: 'drivingDistance', espnName: 'yardsPerDrive', isPercent: false, decimals: 2 },
  { key: 'drivingAccuracy', espnName: 'driveAccuracyPct', isPercent: true, decimals: 2 },
  { key: 'gir', espnName: 'gir', isPercent: true, decimals: 2 },
  { key: 'gir', espnName: 'greensInRegPct', isPercent: true, decimals: 2 },
  { key: 'gir', espnName: 'greensInReg', isPercent: true, decimals: 2 },
  { key: 'gir', espnName: 'girPct', isPercent: true, decimals: 2 },
  { key: 'scrambling', espnName: 'scramblingPct', isPercent: true, decimals: 2 },
  { key: 'scrambling', espnName: 'scrambling', isPercent: true, decimals: 2 },
  { key: 'scrambling', espnName: 'scrambPct', isPercent: true, decimals: 2 },
  { key: 'sandSaves', espnName: 'savePct', isPercent: true, decimals: 2 },
  { key: 'sandSaves', espnName: 'sandSaves', isPercent: true, decimals: 2 },
  { key: 'sandSaves', espnName: 'sandSavePct', isPercent: true, decimals: 2 },
  { key: 'sandSaves', espnName: 'sandSave', isPercent: true, decimals: 2 },
  { key: 'sandSaves', espnName: 'bunkerSavePct', isPercent: true, decimals: 2 },
  { key: 'puttAverage', espnName: 'puttsGirAvg', isPercent: false, decimals: 3 },
  { key: 'sgTotal', espnName: 'strokesGainedTotal', isPercent: false, decimals: 2 },
  { key: 'sgTotal', espnName: 'sgTotal', isPercent: false, decimals: 2 },
  { key: 'sgOffTee', espnName: 'strokesGainedOffTee', isPercent: false, decimals: 2 },
  { key: 'sgOffTee', espnName: 'sgOffTee', isPercent: false, decimals: 2 },
  { key: 'sgApproach', espnName: 'strokesGainedApproach', isPercent: false, decimals: 2 },
  { key: 'sgApproach', espnName: 'sgApproach', isPercent: false, decimals: 2 },
  { key: 'sgAroundGreen', espnName: 'strokesGainedAroundGreen', isPercent: false, decimals: 2 },
  { key: 'sgAroundGreen', espnName: 'sgAroundGreen', isPercent: false, decimals: 2 },
  { key: 'sgPutting', espnName: 'strokesGainedPutting', isPercent: false, decimals: 2 },
  { key: 'sgPutting', espnName: 'sgPutting', isPercent: false, decimals: 2 },
  { key: 'sgTeeToGreen', espnName: 'strokesGainedTeeToGreen', isPercent: false, decimals: 2 },
  { key: 'sgTeeToGreen', espnName: 'sgTeeToGreen', isPercent: false, decimals: 2 },
