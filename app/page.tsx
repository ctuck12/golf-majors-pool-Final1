                        ...
                        {eventLeaderboardRows.filter((player) => player.name.toLowerCase().includes(leaderboardSearch.toLowerCase())).map((player, rowIndex) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td style={{ padding: isMobile ? '6px 4px' : '7px 8px', textAlign: 'center', fontWeight: player.score === 'CUT' || player.score === 'MDF' || player.score === 'WD' || player.score === 'DQ' ? 400 : 700, color: isUnderPar ? '#dc2626' : (player.score === 'CUT' || player.score === 'MDF' || player.score === 'WD' || player.score === 'DQ' ? '#000000' : '#0f1720') }}>{player.score}</td>
