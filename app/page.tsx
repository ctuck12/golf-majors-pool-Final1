                    ...
                    <div key={i} style={{ display: 'flex', alignItems: 'center', padding: '9px 18px', borderBottom: i < statLeaderboardModal.entries!.length - 1 ? '1px solid #f0f4f8' : 'none' }}>
                      ...
                      {getFlagSrc(entry.name) ? (
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginRight: 10, flexShrink: 0 }}>
                          <img src={getFlagSrc(entry.name)} alt="" style={{ height: 18, width: 26, objectFit: 'cover', borderRadius: 3, border: '1px solid #d1d9e0' }} />
                          <span style={{ fontSize: 9, fontWeight: 700, color: '#607282', letterSpacing: '0.04em', marginTop: 2 }}>{getCountryLabel(entry.name)}</span>
                        </div>
