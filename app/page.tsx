                      ...
                      {standings.map((entry) => (
                        ...
                        >
                          ...
                          <td style={{ padding: isMobile ? '10px 8px' : '10px 12px' }}>
                            ...
                            >
                              {entry.name}
                              {isTournamentFinal && entry.place === 1 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 2 }}><span style={{ display: 'flex', gap: 2, marginBottom: 1 }}><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#818cf8,#4f46e5)', borderRadius: '2px 2px 0 0', display: 'block' }} /><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#a5b4fc,#6366f1)', borderRadius: '2px 2px 0 0', display: 'block' }} /></span><span style={{ width: isMobile ? 21 : 24, height: isMobile ? 21 : 24, borderRadius: '50%', background: 'linear-gradient(145deg,#FDE68A,#F59E0B)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 9 : 11, fontWeight: 900, color: '#78350f', border: '2.5px solid #D97706', boxShadow: '0 2px 8px rgba(217,119,6,0.55),inset 0 1px 2px rgba(255,255,255,0.5)' }}>1</span></span>}
                              {isTournamentFinal && entry.place === 2 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 2 }}><span style={{ display: 'flex', gap: 2, marginBottom: 1 }}><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#818cf8,#4f46e5)', borderRadius: '2px 2px 0 0', display: 'block' }} /><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#a5b4fc,#6366f1)', borderRadius: '2px 2px 0 0', display: 'block' }} /></span><span style={{ width: isMobile ? 21 : 24, height: isMobile ? 21 : 24, borderRadius: '50%', background: 'linear-gradient(145deg,#F3F4F6,#9CA3AF)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 9 : 11, fontWeight: 900, color: '#1f2937', border: '2.5px solid #6B7280', boxShadow: '0 2px 8px rgba(107,114,128,0.45),inset 0 1px 2px rgba(255,255,255,0.5)' }}>2</span></span>}
                              {isTournamentFinal && entry.place === 3 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 2 }}><span style={{ display: 'flex', gap: 2, marginBottom: 1 }}><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#818cf8,#4f46e5)', borderRadius: '2px 2px 0 0', display: 'block' }} /><span style={{ width: 5, height: 8, background: 'linear-gradient(180deg,#a5b4fc,#6366f1)', borderRadius: '2px 2px 0 0', display: 'block' }} /></span><span style={{ width: isMobile ? 21 : 24, height: isMobile ? 21 : 24, borderRadius: '50%', background: 'linear-gradient(145deg,#FDBA74,#B45309)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 9 : 11, fontWeight: 900, color: '#fff', border: '2.5px solid #92400E', boxShadow: '0 2px 8px rgba(146,64,14,0.5),inset 0 1px 2px rgba(255,255,255,0.35)' }}>3</span></span>}
                            </div>
                          </td>
