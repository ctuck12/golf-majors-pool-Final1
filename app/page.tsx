              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    ...
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && activeStandingGolfer.name.length > 16) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && activeStandingGolfer.name.length > 16) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && activeStandingGolfer.name.length > 16) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && activeStandingGolfer.name.length > 16) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && activeStandingGolfer.name.length > 16) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && activeStandingGolfer.name.length > 16) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                      </div>
                    )}
                    <button
                ...
                return (
                  <>
                    <div style={{ background: hBg, padding: isMobile ? '14px 16px 12px' : '16px 20px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexShrink: 0 }}>
                      ...
                      {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                        <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && (scorecardGolferName ?? '').length > 16) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && (scorecardGolferName ?? '').length > 16) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && (scorecardGolferName ?? '').length > 16) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && (scorecardGolferName ?? '').length > 16) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && (scorecardGolferName ?? '').length > 16) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && (scorecardGolferName ?? '').length > 16) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                        </div>
                      )}
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    ...
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && cutScorecardGolfer.name.length > 16) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && cutScorecardGolfer.name.length > 16) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && cutScorecardGolfer.name.length > 16) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && cutScorecardGolfer.name.length > 16) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && cutScorecardGolfer.name.length > 16) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && cutScorecardGolfer.name.length > 16) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                      </div>
                    )}
                    <button
                      onClick={() => { setCutScorecardGolfer(null); setCutScorecardData(null); }}
