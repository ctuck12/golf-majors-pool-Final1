                              ...
                              return filteredFull.map((player, rowIndex) => {
                                ...
                                return (
                                  <Fragment key={player.playerId}>
                                    ...
                                    >
                                      <td style={{ padding: isMobile ? '6px 4px' : '7px 8px', textAlign: 'center', fontWeight: 600, color: selectedTournament === 'open' ? '#0f1720' : '#374151' }}>{notStartedR1 ? '—' : (player.score === 'WD' || player.score === 'DQ') ? <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#cc2944', color: '#fff', borderRadius: 4, padding: '2px 5px', minWidth: 28, fontWeight: 700, fontSize: isMobile ? 10 : 11 }}>{player.score}</span> : formatLeaderboardPosition(player.position)}</td>
