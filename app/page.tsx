                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
                      ...
                      {TOURNAMENT_TAB_LOGOS[tournament.id] && (
                        <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
                          <img src={KNOCKOUT_TAB_LOGOS[tournament.id] ?? TOURNAMENT_TAB_LOGOS[tournament.id]} alt={tournament.name} style={{ height: tournament.id === 'pga' ? 60 : tournament.id === 'players' ? 52 : tournament.id === 'open' ? 40 : tournament.id === 'masters' ? undefined : 36, width: tournament.id === 'masters' ? 110 : undefined, margin: tournament.id === 'pga' ? '-8px 0' : tournament.id === 'players' ? '-4px 0' : undefined, maxWidth: 110, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                        </div>
                      )}
                    </div>
