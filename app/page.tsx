                ...
                {showLivePayoutStrip ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6, flexShrink: 0 }}>
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                      <div style={{ borderRadius: 999, background: '#eef4ff', color: '#2f5f96', padding: isMobile ? '4px 9px' : '6px 10px', fontSize: isMobile ? 11 : 13, fontWeight: 800 }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                      {standings.map((entry) => (
                        ...
                        >
                          <td style={{ padding: isMobile ? '11px 8px 11px 4px' : '11px 12px 11px 8px', fontSize: isMobile ? 12 : 13, textAlign: 'center' }}>{entry.place}</td>
                          <td style={{ padding: isMobile ? '11px 8px' : '11px 12px' }}>
                            <div
                              style={{
                          ...
                          <td style={{ padding: isMobile ? '11px 8px' : '11px 12px', textAlign: 'center', fontSize: isMobile ? 12 : 14 }}>
                            {entry.rosterPoints % 1 === 0 ? entry.rosterPoints : entry.rosterPoints.toFixed(1)}
                          </td>
                          <td style={{ padding: isMobile ? '11px 8px' : '11px 12px', textAlign: 'center', fontSize: isMobile ? 12 : 14 }}>
                            {entry.holesRemaining}
                          </td>
                          <td style={{ padding: isMobile ? '11px 8px 11px 4px' : '11px 8px', textAlign: 'center', fontSize: isMobile ? 12 : 14 }}>{entry.tieBreakValue}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
