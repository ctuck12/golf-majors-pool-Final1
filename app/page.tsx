                  ...
                  return (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'stretch', gap: 0, borderRadius: 12, overflow: 'hidden', border: '1.5px solid #e2e8ef', marginBottom: 10 }}>
                        {/* Photo column */}
                        <div style={{ flexShrink: 0, width: 115, background: '#e8edf2', display: 'flex', alignItems: 'stretch' }}>
                          <img
                            src={photoSrc}
                            alt={pickHistoryPlayerPopup.player.name}
                            style={{ width: 115, objectFit: 'cover', objectPosition: 'center top', display: 'block' }}
                            onError={(e) => {
