...
function fitPopupHeader(name: string, abbr: string | null | undefined | false, popupMaxW: number, padH: number, tournamentId: TournamentId, mobile: boolean): { fontSize: number; flagH: number; stacked: boolean; shrinkLogo: boolean } {
  ...
  for (const fs of sizes) {
    const flagH = mobile && fs !== sizes[0] ? 16 : 20;
  ...
  return { fontSize: sizes[2], flagH: mobile ? 16 : 20, stacked: true, shrinkLogo: true };
}
