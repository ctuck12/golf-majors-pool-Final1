...
const FLAG_LABELS: Record<string, string> = { 'us': 'USA', 'gb-eng': 'ENG', 'gb-nir': 'NIR', 'au': 'AUS', 'ie': 'IRL', 'gb-sct': 'SCT', 'no': 'NOR', 'es': 'ESP', 'kr': 'KOR', 'jp': 'JPN', 'za': 'RSA', 'se': 'SWE', 'ca': 'CAN', 'nz': 'NZL', 'dk': 'DEN', 'de': 'GER', 'cl': 'CHI', 'co': 'COL', 'mx': 'MEX', 'ar': 'ARG', 've': 'VEN', 'be': 'BEL', 'at': 'AUT', 'fr': 'FRA', 'gb-wls': 'WAL', 'fi': 'FIN', 'cn': 'CHN', 'it': 'ITA', 'in': 'IND', 'ph': 'PHI', 'fj': 'FIJ', 'pr': 'PRI' };
                ...
                {showLivePayoutStrip ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6, flexShrink: 0 }}>
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                      <div style={{ borderRadius: 999, background: selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'pga' ? '#B09963' : selectedTournament === 'us-open' ? '#BE3436' : '#173b63', padding: isMobile ? '4px 9px' : '6px 10px', fontSize: isMobile ? 11 : 13, fontWeight: 800, color: '#fff', border: selectedTournament === 'masters' ? '1.5px solid #1a4a33' : selectedTournament === 'pga' ? '1.5px solid #8a7040' : selectedTournament === 'us-open' ? '1.5px solid #7b1a13' : '1.5px solid #0f2448', boxShadow: selectedTournament === 'masters' ? '0 2px 8px rgba(30,80,50,0.45)' : selectedTournament === 'pga' ? '0 2px 8px rgba(140,112,64,0.4)' : selectedTournament === 'us-open' ? '0 2px 8px rgba(160,40,30,0.4)' : '0 2px 8px rgba(14,45,100,0.4)' }}>
                      ...
                      {standings.map((entry) => (
                        ...
                        >
                          ...
                          <td style={{ padding: isMobile ? '10px 8px' : '10px 12px' }}>
                            ...
                            >
                              {entry.name}
                              {isTournamentFinal && entry.place === 1 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 3, filter: 'drop-shadow(0 3px 5px rgba(0,0,0,0.28))' }}><span style={{ width: 8, height: 5, border: '2px solid #6d28d9', borderBottom: 'none', borderRadius: '4px 4px 0 0', display: 'block' }} /><span style={{ display: 'flex', width: isMobile ? 16 : 18, height: isMobile ? 16 : 19, marginBottom: 0 }}><span style={{ flex: 1, background: 'linear-gradient(175deg,#a78bfa 0%,#5b21b6 100%)' }} /><span style={{ flex: 1, background: 'linear-gradient(185deg,#7c3aed 0%,#3b0764 100%)' }} /></span><span style={{ width: isMobile ? 26 : 30, height: isMobile ? 26 : 30, borderRadius: '50%', background: 'radial-gradient(circle at 36% 30%, #fffbeb, #fde68a 28%, #f59e0b 60%, #b45309)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 11 : 13, fontWeight: 900, color: '#78350f', border: '2px solid #92400e', boxShadow: '0 3px 10px rgba(180,83,9,0.5),inset 0 0 0 2.5px rgba(253,230,138,0.6),inset 0 2px 4px rgba(255,255,255,0.7),inset 0 -2px 4px rgba(0,0,0,0.2)' }}>1</span></span>}
                              {isTournamentFinal && entry.place === 2 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 3, filter: 'drop-shadow(0 3px 5px rgba(0,0,0,0.28))' }}><span style={{ width: 8, height: 5, border: '2px solid #4b5563', borderBottom: 'none', borderRadius: '4px 4px 0 0', display: 'block' }} /><span style={{ display: 'flex', width: isMobile ? 16 : 18, height: isMobile ? 16 : 19, marginBottom: 0 }}><span style={{ flex: 1, background: 'linear-gradient(175deg,#e5e7eb 0%,#6b7280 100%)' }} /><span style={{ flex: 1, background: 'linear-gradient(185deg,#9ca3af 0%,#374151 100%)' }} /></span><span style={{ width: isMobile ? 26 : 30, height: isMobile ? 26 : 30, borderRadius: '50%', background: 'radial-gradient(circle at 36% 30%, #ffffff, #e5e7eb 28%, #9ca3af 60%, #374151)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 11 : 13, fontWeight: 900, color: '#111827', border: '2px solid #4b5563', boxShadow: '0 3px 10px rgba(75,85,99,0.5),inset 0 0 0 2.5px rgba(229,231,235,0.6),inset 0 2px 4px rgba(255,255,255,0.8),inset 0 -2px 4px rgba(0,0,0,0.2)' }}>2</span></span>}
                              {isTournamentFinal && entry.place === 3 && <span style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', verticalAlign: 'middle', lineHeight: 1, marginLeft: 3, filter: 'drop-shadow(0 3px 5px rgba(0,0,0,0.28))' }}><span style={{ width: 8, height: 5, border: '2px solid #7c2d12', borderBottom: 'none', borderRadius: '4px 4px 0 0', display: 'block' }} /><span style={{ display: 'flex', width: isMobile ? 16 : 18, height: isMobile ? 16 : 19, marginBottom: 0 }}><span style={{ flex: 1, background: 'linear-gradient(175deg,#fdba74 0%,#c2410c 100%)' }} /><span style={{ flex: 1, background: 'linear-gradient(185deg,#ea580c 0%,#7c2d12 100%)' }} /></span><span style={{ width: isMobile ? 26 : 30, height: isMobile ? 26 : 30, borderRadius: '50%', background: 'radial-gradient(circle at 36% 30%, #fed7aa, #fb923c 28%, #c2410c 60%, #7c2d12)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: isMobile ? 11 : 13, fontWeight: 900, color: '#fff', border: '2px solid #7c2d12', boxShadow: '0 3px 10px rgba(124,45,18,0.5),inset 0 0 0 2.5px rgba(253,186,116,0.5),inset 0 2px 4px rgba(255,255,255,0.5),inset 0 -2px 4px rgba(0,0,0,0.25)' }}>3</span></span>}
                            </div>
                          </td>
                        ...
                        <>
                          ...
                          <div style={{ flex: 1, minWidth: 0, padding: '10px 12px', display: 'flex', justifyContent: 'space-between', gap: 8, alignItems: 'center', background: selectedTournament === 'open' ? '#F4BC41' : 'transparent' }}>
                              ...
                              {golfer.score !== 'CUT' && golfer.score !== 'MDF' && (
                                <div className="breakdown-golfer-subtext" style={{ marginTop: 2, color: selectedTournament === 'open' ? '#1a1a1a' : '#50616f', fontSize: 12, display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'baseline' }}>
                                  <button
                                    ...
                                    style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', color: selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'open' ? '#1a1a1a' : '#173b63', fontWeight: 700, fontSize: 'inherit', textDecoration: 'none', verticalAlign: 'middle' }}
                                  >
                                    <span style={{ fontWeight: 900, fontSize: '1.1em', textDecoration: 'none', color: selectedTournament === 'open' ? '#173b63' : 'inherit' }}>{currentRoundLabel}:</span>{' '}<span style={{ color: selectedTournament === 'open' ? '#1a1a1a' : '#50616f', fontWeight: 400 }}>{golfer.thru === '--' && selectedTournamentStatus?.label === 'IN PROGRESS' && golfer.teeTime ? formatTeeTime(golfer.teeTime) : formatCurrentRoundScore(golfer.currentRoundScore ?? undefined, golfer.score)}</span>
                                  </button>
                            ...
                            <div style={{ textAlign: 'right', minWidth: 40, flexShrink: 0 }}>
                              <div className="breakdown-golfer-points" style={{ fontSize: 22, fontWeight: 900, color: golfer.points < 0 ? '#dc2626' : selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'players' ? '#173b63' : '#173b63' }}>{formatPointValue(golfer.points)}</div>
                            </div>
                          </div>
                        </>
                      ) : (
                  ...
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6, flexWrap: 'wrap' }}>
                        <div style={{ borderRadius: 999, background: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AB43' : '#1e3a5f', padding: '3px 10px', fontSize: 13, fontWeight: 700, color: selectedTournament === 'masters' ? '#2c6449' : '#fff', lineHeight: 1.2, flexShrink: 0, border: selectedTournament === 'masters' ? '1.5px solid #c8b800' : selectedTournament === 'players' ? '1.5px solid #a07010' : '1.5px solid #0f2448', boxShadow: selectedTournament === 'masters' ? '0 2px 8px rgba(180,150,0,0.45)' : selectedTournament === 'players' ? '0 2px 8px rgba(180,140,0,0.4)' : '0 2px 8px rgba(14,45,100,0.4)' }}>
                              ...
                              <div style={{ fontSize: isMobile ? 11 : 12, fontWeight: 800, color: roundColor, display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
                                ...
                                {hasPrev && (
                                  <button
                                    ...
                                    style={{ background: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AB43' : '#1e3a5f', border: selectedTournament === 'masters' ? '1.5px solid #c8b800' : selectedTournament === 'players' ? '1.5px solid #a07010' : '1.5px solid #0f2448', borderRadius: 999, padding: isMobile ? '2.5px 7.5px' : '3px 8px', cursor: 'pointer', color: selectedTournament === 'masters' ? '#2c6449' : '#fff', fontWeight: 800, fontSize: isMobile ? 8 : 9, letterSpacing: '0.06em', boxShadow: selectedTournament === 'masters' ? '0 2px 8px rgba(180,150,0,0.45)' : selectedTournament === 'players' ? '0 2px 8px rgba(180,140,0,0.4)' : '0 2px 8px rgba(14,45,100,0.4)', textTransform: 'uppercase' }}
                                  >
                                    Previous Rounds
                                  </button>
                                )}
                    ...
                    return (
                      <div key={rnd.round} style={{ marginBottom: 24 }}>
                        <div style={{ marginBottom: 8, display: 'flex', alignItems: 'center', gap: 8 }}>
                          <span style={{ background: isMastersTournament ? '#F3E44D' : selectedTournament === 'players' ? '#E0AB43' : selectedTournament === 'pga' ? '#1e4d8c' : selectedTournament === 'us-open' ? '#BE3436' : selectedTournament === 'open' ? '#c0392b' : '#1e3a5f', color: isMastersTournament ? '#2c6449' : '#fff', borderRadius: 999, padding: '3px 10px', fontSize: 11, fontWeight: 800, letterSpacing: '0.05em', textTransform: 'uppercase', border: isMastersTournament ? '1.5px solid #c8b800' : selectedTournament === 'players' ? '1.5px solid #a07010' : selectedTournament === 'pga' ? '1.5px solid #0f2d6b' : selectedTournament === 'us-open' ? '1.5px solid #7b1a13' : selectedTournament === 'open' ? '1.5px solid #7b1a13' : '1.5px solid #0f2448', boxShadow: isMastersTournament ? '0 2px 8px rgba(180,150,0,0.45)' : selectedTournament === 'players' ? '0 2px 8px rgba(180,140,0,0.4)' : selectedTournament === 'pga' ? '0 2px 8px rgba(14,45,100,0.4)' : selectedTournament === 'us-open' ? '0 2px 8px rgba(160,40,30,0.4)' : selectedTournament === 'open' ? '0 2px 8px rgba(160,40,30,0.4)' : '0 2px 8px rgba(14,45,100,0.4)' }}>Round {rnd.round}</span>
                        ...
                        <div key={cat.label} style={{ background: selectedTournament === 'open' ? '#F4BC41' : '#f7f9fb', borderRadius: 12, border: '1px solid #e2e8ef', overflow: 'hidden' }}>
                          ...
                          >
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                              {hasEarners ? (
                                <span style={{ fontSize: 11, fontWeight: 800, color: selectedTournament === 'masters' ? '#2c6449' : '#fff', background: (selectedTournament === 'pga' || selectedTournament === 'us-open') ? '#1e4d8c' : selectedTournament === 'open' ? '#c0392b' : selectedTournament === 'masters' ? '#F3E44D' : '#E0AB43', borderRadius: 999, padding: '1px 8px', minWidth: 22, textAlign: 'center', border: (selectedTournament === 'pga' || selectedTournament === 'us-open') ? '1.5px solid #0f2d6b' : selectedTournament === 'open' ? '1.5px solid #7b1a13' : selectedTournament === 'masters' ? '1.5px solid #c8b800' : '1.5px solid #a07010', boxShadow: (selectedTournament === 'pga' || selectedTournament === 'us-open') ? '0 2px 8px rgba(14,45,100,0.4)' : selectedTournament === 'open' ? '0 2px 8px rgba(160,40,30,0.4)' : selectedTournament === 'masters' ? '0 2px 8px rgba(180,150,0,0.45)' : '0 2px 8px rgba(180,140,0,0.4)' }}>{earnerCount}</span>
                              ) : (
