              ...
              {showFutureTournamentView ? (
                ...
                <div style={{ marginTop: isMobile ? 14 : 28, overflowX: 'auto' }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ background: selectedTournament === 'pga' ? '#B09963' : selectedTournament === 'masters' ? '#2c6449' : '#173b63', color: selectedTournament === 'masters' ? '#F3E44D' : '#ffffff', fontSize: isMobile ? 10 : 11, textAlign: 'left' }}>
