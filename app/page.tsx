                    ...
                    {!showFinalTournamentView && roundOneComplete && !isTournamentFinal && (
                      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        ...
                        <button
                          ...
                          style={{ fontSize: isMobile ? 9 : 10, fontWeight: 800, color: '#0f1720', background: (selectedTournament === 'pga' || selectedTournament === 'us-open') ? 'linear-gradient(135deg, #1e4d8c, #0a1f3d)' : selectedTournament === 'open' ? 'linear-gradient(135deg, #c0392b, #7b1010)' : selectedTournament === 'masters' ? 'linear-gradient(135deg, #F3E44D, #d4a800)' : 'linear-gradient(135deg, #c9a84c, #8a6528)', border: 'none', cursor: 'pointer', padding: isMobile ? '3px 8px' : '4px 9px', borderRadius: 999, letterSpacing: '0.06em', boxShadow: (selectedTournament === 'pga' || selectedTournament === 'us-open') ? '0 1px 5px rgba(14,45,100,0.45)' : selectedTournament === 'open' ? '0 1px 5px rgba(150,30,30,0.45)' : selectedTournament === 'masters' ? '0 1px 5px rgba(180,150,0,0.4)' : '0 1px 5px rgba(176,153,99,0.4)', textTransform: 'uppercase' }}
                        >
                          Bonus Points
                        </button>
                      </div>
