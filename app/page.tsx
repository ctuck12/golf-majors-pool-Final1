                    ...
                    <div style={{ border: '1px solid #d7e0e8', borderRadius: 20, overflow: 'hidden', background: '#fff' }}>
                      ...
                      >
                        ...
                        {TOURNAMENT_EVENT_LOGOS[entriesTournamentId] && (
                          <img src={TOURNAMENT_EVENT_LOGOS[entriesTournamentId]} alt={entriesTournament.name} style={{ position: isMobile || isLandscapePhone ? 'absolute' : 'static', top: isMobile ? 12 : isLandscapePhone ? 2 : undefined, right: isMobile ? 28 : isLandscapePhone ? 72 : undefined, height: isMobile ? 132 : isLandscapePhone ? 206 : 140, width: 'auto', objectFit: 'contain', pointerEvents: 'none', flexShrink: 0 }} />
                        )}
                        <label
                          style={{
