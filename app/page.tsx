                ...
                {showLivePayoutStrip ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6, flexShrink: 0 }}>
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                      <div style={{ borderRadius: 999, background: selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'pga' ? '#B09963' : '#173b63', padding: isMobile ? '4px 9px' : '6px 10px', fontSize: isMobile ? 11 : 13, fontWeight: 800, color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>
                        1st: <span style={{ color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>{formatPayoutAmount(selectedTournamentPayouts?.first)}</span>
                      </div>
                      <div style={{ borderRadius: 999, background: selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'pga' ? '#B09963' : '#173b63', padding: isMobile ? '4px 9px' : '6px 10px', fontSize: isMobile ? 11 : 13, fontWeight: 800, color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>
                        2nd: <span style={{ color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>{formatPayoutAmount(selectedTournamentPayouts?.second)}</span>
                      </div>
                      <div style={{ borderRadius: 999, background: selectedTournament === 'masters' ? '#2c6449' : selectedTournament === 'pga' ? '#B09963' : '#173b63', padding: isMobile ? '4px 9px' : '6px 10px', fontSize: isMobile ? 11 : 13, fontWeight: 800, color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>
                        3rd: <span style={{ color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AA43' : selectedTournament === 'pga' ? '#173b63' : '#fff' }}>{formatPayoutAmount(selectedTournamentPayouts?.third)}</span>
                      </div>
                    </div>
