                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
                    {tournament.id === 'pga' ? (
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: isMobile ? 4 : 6, width: '100%' }}>
                        <img src="/pga-tab-logo.png" alt="PGA" style={{ height: isMobile ? 38 : 52, objectFit: 'contain', flexShrink: 0, margin: isMobile ? '-8px 0' : '-12px 0', transform: isMobile ? 'translateY(6px)' : 'translateY(10px)' }} />
