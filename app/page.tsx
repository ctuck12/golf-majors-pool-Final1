            ...
            >
              ...
              {scorecardLoading ? (
                ...
                const totalCell: React.CSSProperties = {
                  ...baseCell, fontWeight: 900, background: isMastersTournament ? '#1a3d2b' : isRedTotalTournament ? '#1e4d8c' : '#1e3a5f', color: '#fff', borderLeft: thickBorder,
                };
                ...
                const totalHeaderCell: React.CSSProperties = {
                  ...holeHeaderCell, background: isMastersTournament ? '#1a3d2b' : isRedTotalTournament ? '#1e4d8c' : '#1e3a5f', borderLeft: thickBorder,
                };
            ...
            >
              ...
              <div style={{ padding: isMobile ? '14px 14px 20px' : '16px 20px 24px', overflowX: 'auto' }}>
                {(() => {
                  ...
                  const totalCell: React.CSSProperties = { ...baseCell, fontWeight: 900, background: isMastersTournament ? '#1a3d2b' : isRedTotalTournament ? '#1e4d8c' : '#1e3a5f', color: '#fff', borderLeft: thickBorder };
                  ...
                  const totalHeaderCell: React.CSSProperties = { ...holeHeaderCell, background: isMastersTournament ? '#1a3d2b' : isRedTotalTournament ? '#1e4d8c' : '#1e3a5f', borderLeft: thickBorder };
                  const fmt = (n: number) => n > 0 ? `+${n}` : n === 0 ? 'E' : `${n}`;
                  const badge = (score: number, par: number): React.CSSProperties => {
