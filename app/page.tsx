              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: (isMobile && activeStandingGolfer.name.length > 16) ? 15 : isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', minWidth: 0, whiteSpace: 'nowrap' }}><span style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{activeStandingGolfer.name}</span>{getPlayerFlag(activeStandingGolfer.name) && <><span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', marginLeft: 8, verticalAlign: 'middle', flexShrink: 0 }}><img src={getFlagSrc(activeStandingGolfer.name)} alt="" style={{ height: (isMobile && (activeStandingGolfer.name).length > 16) ? 16 : 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(activeStandingGolfer.name) && ((activeStandingGolfer.name).length > 14 ? <span style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: 2, color: '#fff', fontWeight: 400, fontSize: 10, lineHeight: 1 }}>{getCountryLabel(activeStandingGolfer.name)}</span> : <span style={{ marginLeft: 5, color: '#fff', fontWeight: 400, fontSize: 13, lineHeight: 1 }}>{getCountryLabel(activeStandingGolfer.name)}</span>)}</span>{(PGA_CLUB_PROFESSIONALS.has(activeStandingGolfer.name) || clubProKeys.has(canonicalNameKey(activeStandingGolfer.name))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                    ...
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && activeStandingGolfer.name.length > 21) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && activeStandingGolfer.name.length > 21) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && activeStandingGolfer.name.length > 21) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && activeStandingGolfer.name.length > 21) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && activeStandingGolfer.name.length > 21) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && activeStandingGolfer.name.length > 21) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                      </div>
                    )}
                    <button
                ...
                return (
                  <div style={{ background: hBg, display: 'flex', alignItems: 'stretch', flexShrink: 0 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, padding: isMobile ? '10px 14px' : '12px 18px' }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: !scorecardGolferName ? 19 : scorecardGolferName.length > 22 ? (isMobile ? 14 : 16) : scorecardGolferName.length > 18 ? (isMobile ? 16 : 18) : (isMobile && scorecardGolferName.length > 16) ? 15 : isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', lineHeight: 1.1, display: 'flex', alignItems: 'center', minWidth: 0, whiteSpace: 'nowrap' }}><span style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{scorecardGolferName}</span>{scorecardGolferName && getPlayerFlag(scorecardGolferName) && <><span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', marginLeft: 8, verticalAlign: 'middle', flexShrink: 0 }}><img src={getFlagSrc(scorecardGolferName)} alt="" style={{ height: (isMobile && (scorecardGolferName).length > 16) ? 16 : 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(scorecardGolferName) && ((scorecardGolferName).length > 14 ? <span style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: 2, color: '#fff', fontWeight: 400, fontSize: 10, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span> : <span style={{ marginLeft: 5, color: '#fff', fontWeight: 400, fontSize: 13, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span>)}</span></>}</div>
                        {(() => {
                      ...
                      {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && (scorecardGolferName ?? '').length > 21) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && (scorecardGolferName ?? '').length > 21) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                      </div>
                    )}
                    <button
                        onClick={() => { setScorecardGolferName(null); setScorecardData(null); setScorecardGolferTeeTime(null); setScorecardGolferThru(null); setScorecardGolferBackNineStart(false); setShowPreviousRounds(false); }}
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: (isMobile && (scorecardGolferName ?? '').length > 16) ? 15 : isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', minWidth: 0, whiteSpace: 'nowrap' }}><span style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{scorecardGolferName}</span>{scorecardGolferName && getPlayerFlag(scorecardGolferName) && <><span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', marginLeft: 8, verticalAlign: 'middle', flexShrink: 0 }}><img src={getFlagSrc(scorecardGolferName)} alt="" style={{ height: (isMobile && (scorecardGolferName).length > 16) ? 16 : 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(scorecardGolferName) && ((scorecardGolferName).length > 14 ? <span style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: 2, color: '#fff', fontWeight: 400, fontSize: 10, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span> : <span style={{ marginLeft: 5, color: '#fff', fontWeight: 400, fontSize: 13, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span>)}</span>{scorecardGolferName && (PGA_CLUB_PROFESSIONALS.has(scorecardGolferName) || clubProKeys.has(canonicalNameKey(scorecardGolferName))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                    </div>
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && (scorecardGolferName ?? '').length > 21) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && (scorecardGolferName ?? '').length > 21) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && (scorecardGolferName ?? '').length > 21) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: (isMobile && cutScorecardGolfer.name.length > 16) ? 15 : isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', minWidth: 0, whiteSpace: 'nowrap' }}><span style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{cutScorecardGolfer.name}</span>{getPlayerFlag(cutScorecardGolfer.name) && <><span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', marginLeft: 8, verticalAlign: 'middle', flexShrink: 0 }}><img src={getFlagSrc(cutScorecardGolfer.name)} alt="" style={{ height: (isMobile && (cutScorecardGolfer.name).length > 16) ? 16 : 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(cutScorecardGolfer.name) && ((cutScorecardGolfer.name).length > 14 ? <span style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: 2, color: '#fff', fontWeight: 400, fontSize: 10, lineHeight: 1 }}>{getCountryLabel(cutScorecardGolfer.name)}</span> : <span style={{ marginLeft: 5, color: '#fff', fontWeight: 400, fontSize: 13, lineHeight: 1 }}>{getCountryLabel(cutScorecardGolfer.name)}</span>)}</span>{(PGA_CLUB_PROFESSIONALS.has(cutScorecardGolfer.name) || clubProKeys.has(canonicalNameKey(cutScorecardGolfer.name))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                    </div>
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? ((isMobile && cutScorecardGolfer.name.length > 21) ? 46 : 60) : selectedTournament === 'players' ? ((isMobile && cutScorecardGolfer.name.length > 21) ? 40 : 52) : selectedTournament === 'open' ? ((isMobile && cutScorecardGolfer.name.length > 21) ? 30 : 40) : selectedTournament === 'masters' ? undefined : ((isMobile && cutScorecardGolfer.name.length > 21) ? 28 : 36), width: selectedTournament === 'masters' ? ((isMobile && cutScorecardGolfer.name.length > 21) ? 92 : 120) : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: (isMobile && cutScorecardGolfer.name.length > 21) ? 92 : 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
                      </div>
                    )}
                    <button
                      onClick={() => { setCutScorecardGolfer(null); setCutScorecardData(null); }}
