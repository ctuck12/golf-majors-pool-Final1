              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div>
                      <div style={{ fontSize: isMobile ? 10 : 11, fontWeight: 700, color: selectedTournament === 'masters' ? '#F3E44D' : selectedTournament === 'players' ? '#E0AB43' : 'rgba(255,255,255,0.7)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 2 }}>{selectedTournament === 'masters' ? 'The Masters Tournament' : tournament.fullName}</div>
                    ...
                    {alwaysOpenCats.map((cat) => {
                      ...
                      return (
                        <div key={cat.label} style={{ background: (selectedTournament === 'pga' || selectedTournament === 'open') ? '#F4BC41' : '#fff', borderRadius: 12, border: '1px solid #e2e8ef', padding: '12px 14px', boxShadow: '0 2px 6px rgba(9,34,51,0.05)' }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8, paddingBottom: 8, marginBottom: 8, borderBottom: (isMobile && selectedTournament === 'pga') ? '0.75px solid #dae8ef' : (isMobile && selectedTournament === 'open') ? '0.75px solid #c5d4dc' : (isMobile && selectedTournament === 'players') ? '1px solid #f0f4f7' : (selectedTournament === 'pga' || selectedTournament === 'open') ? '0.5px solid #c5d4dc' : '1px solid #edf1f6' }}>
                      ...
                      return (
                        <div key={cat.label} style={{ background: (selectedTournament === 'pga' || selectedTournament === 'open') ? '#F4BC41' : '#f7f9fb', borderRadius: 12, border: '1px solid #e2e8ef', overflow: 'hidden' }}>
                          <button
                            ...
                            style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: isMobile ? '10px 12px' : '11px 14px', background: (selectedTournament === 'pga' || selectedTournament === 'open') ? '#F4BC41' : '#fff', border: 'none', borderBottom: isOpen ? ((isMobile && selectedTournament === 'pga') ? '0.75px solid #dae8ef' : (isMobile && selectedTournament === 'open') ? '0.75px solid #c5d4dc' : (isMobile && selectedTournament === 'players') ? '1px solid #f0f4f7' : (selectedTournament === 'pga' || selectedTournament === 'open') ? '0.5px solid #c5d4dc' : '1px solid #edf1f6') : '1px solid transparent', cursor: 'pointer', textAlign: 'left', WebkitTapHighlightColor: 'transparent', transition: 'border-color 0.2s ease' }}
                          >
