              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div>
                      <div style={{ fontSize: isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em' }}>{activeStandingGolfer.name}{getPlayerFlag(activeStandingGolfer.name) && <><span style={{ display: 'inline-flex', flexDirection: (activeStandingGolfer.name).length > 14 ? 'column' : 'row', alignItems: 'center', gap: (activeStandingGolfer.name).length > 14 ? 2 : 5, marginLeft: 8, verticalAlign: 'middle' }}><img src={getFlagSrc(activeStandingGolfer.name)} alt="" style={{ height: 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(activeStandingGolfer.name) && <span style={{ color: '#fff', fontWeight: 400, fontSize: (activeStandingGolfer.name).length > 14 ? 11 : 13, lineHeight: 1 }}>{getCountryLabel(activeStandingGolfer.name)}</span>}</span>{(PGA_CLUB_PROFESSIONALS.has(activeStandingGolfer.name) || clubProKeys.has(canonicalNameKey(activeStandingGolfer.name))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                ...
                return (
                  <div style={{ background: hBg, display: 'flex', alignItems: 'stretch', flexShrink: 0 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, padding: isMobile ? '10px 14px' : '12px 18px' }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: !scorecardGolferName ? 19 : scorecardGolferName.length > 22 ? (isMobile ? 14 : 16) : scorecardGolferName.length > 18 ? (isMobile ? 16 : 18) : isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', lineHeight: 1.1 }}>{scorecardGolferName}{scorecardGolferName && getPlayerFlag(scorecardGolferName) && <><span style={{ display: 'inline-flex', flexDirection: (scorecardGolferName).length > 14 ? 'column' : 'row', alignItems: 'center', gap: (scorecardGolferName).length > 14 ? 2 : 5, marginLeft: 8, verticalAlign: 'middle' }}><img src={getFlagSrc(scorecardGolferName)} alt="" style={{ height: 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(scorecardGolferName) && <span style={{ color: '#fff', fontWeight: 400, fontSize: (scorecardGolferName).length > 14 ? 11 : 13, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span>}</span></>}</div>
                        {(() => {
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div>
                      <div style={{ fontSize: isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em' }}>{scorecardGolferName}{scorecardGolferName && getPlayerFlag(scorecardGolferName) && <><span style={{ display: 'inline-flex', flexDirection: (scorecardGolferName).length > 14 ? 'column' : 'row', alignItems: 'center', gap: (scorecardGolferName).length > 14 ? 2 : 5, marginLeft: 8, verticalAlign: 'middle' }}><img src={getFlagSrc(scorecardGolferName)} alt="" style={{ height: 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(scorecardGolferName) && <span style={{ color: '#fff', fontWeight: 400, fontSize: (scorecardGolferName).length > 14 ? 11 : 13, lineHeight: 1 }}>{getCountryLabel(scorecardGolferName)}</span>}</span>{scorecardGolferName && (PGA_CLUB_PROFESSIONALS.has(scorecardGolferName) || clubProKeys.has(canonicalNameKey(scorecardGolferName))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                    </div>
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? 60 : selectedTournament === 'players' ? 52 : selectedTournament === 'open' ? 40 : selectedTournament === 'masters' ? undefined : 36, width: selectedTournament === 'masters' ? 120 : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: hBg, padding: isMobile ? '16px 18px 14px' : '18px 22px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexShrink: 0 }}>
                    <div>
                      <div style={{ fontSize: isMobile ? 18 : 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.01em' }}>{cutScorecardGolfer.name}{getPlayerFlag(cutScorecardGolfer.name) && <><span style={{ display: 'inline-flex', flexDirection: (cutScorecardGolfer.name).length > 14 ? 'column' : 'row', alignItems: 'center', gap: (cutScorecardGolfer.name).length > 14 ? 2 : 5, marginLeft: 8, verticalAlign: 'middle' }}><img src={getFlagSrc(cutScorecardGolfer.name)} alt="" style={{ height: 20, display: 'block', borderRadius: 3 }} />{getCountryLabel(cutScorecardGolfer.name) && <span style={{ color: '#fff', fontWeight: 400, fontSize: (cutScorecardGolfer.name).length > 14 ? 11 : 13, lineHeight: 1 }}>{getCountryLabel(cutScorecardGolfer.name)}</span>}</span>{(PGA_CLUB_PROFESSIONALS.has(cutScorecardGolfer.name) || clubProKeys.has(canonicalNameKey(cutScorecardGolfer.name))) && <img src="/pga-seal-gold.png" alt="PGA" style={{ marginLeft: 6, height: 38, verticalAlign: 'middle', display: 'inline-block', objectFit: 'contain' }} />}</>}</div>
                    </div>
                    {TOURNAMENT_TAB_LOGOS[selectedTournament] && (
                      <div style={{ flexShrink: 0, marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={KNOCKOUT_TAB_LOGOS[selectedTournament] ?? TOURNAMENT_TAB_LOGOS[selectedTournament]} alt={tournament.fullName} style={{ height: selectedTournament === 'pga' ? 60 : selectedTournament === 'players' ? 52 : selectedTournament === 'open' ? 40 : selectedTournament === 'masters' ? undefined : 36, width: selectedTournament === 'masters' ? 120 : undefined, margin: selectedTournament === 'pga' ? '-12px 0' : selectedTournament === 'players' ? '-8px 0' : undefined, maxWidth: 120, objectFit: 'contain', display: 'block', flexShrink: 0 }} />
