...
// Ludvig Aberg=5, Akshay Bhatia=14, Viktor Hovland=17, Collin Morikawa=4, Xander Schauffele=3, Gary Woodland=66
const MASTERS_ROSTER = [5, 14, 17, 4, 3, 66];
const TIEBREAK = 285;
const TARGET_DISPLAY_NAME = 'Robert Berrios';
