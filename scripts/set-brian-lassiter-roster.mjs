...
// Ludvig Aberg=5, Akshay Bhatia=14, Tommy Fleetwood=6, Min Woo Lee=12, Hideki Matsuyama=8, Justin Rose=61
const MASTERS_ROSTER = [5, 14, 6, 12, 8, 61];
const TIEBREAK = 276;
const TARGET_DISPLAY_NAME = 'Brian Lassiter';
