...
// Keegan Bradley=36, Bryson DeChambeau=15, Jon Rahm=16, Aaron Rai=126, J.J. Spaun=53, Cameron Young=23
const MASTERS_ROSTER = [36, 15, 16, 126, 53, 23];
const TIEBREAK = 274;
const TARGET_DISPLAY_NAME = 'Tanner Garces';
