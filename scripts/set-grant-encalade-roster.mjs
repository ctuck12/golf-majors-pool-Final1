...
// Tommy Fleetwood=6, Si Woo Kim=37, Patrick Reed=90, Xander Schauffele=3, J.J. Spaun=53, Cameron Young=23
const MASTERS_ROSTER = [6, 37, 90, 3, 53, 23];
const TIEBREAK = 276;
const TARGET_DISPLAY_NAME = 'Grant Encalade';
