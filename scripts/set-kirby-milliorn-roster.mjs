...
// Ludvig Aberg=5, Jason Day=27, Michael Kim=59, Rory McIlroy=2, Patrick Reed=90, Justin Rose=61
const MASTERS_ROSTER = [5, 27, 59, 2, 90, 61];
const TIEBREAK = 280;
const TARGET_DISPLAY_NAME = 'Kirby Milliorn';
