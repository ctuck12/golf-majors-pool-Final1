...
// Ludvig Aberg=5, Akshay Bhatia=14, Matt Fitzpatrick=20, Robert MacIntyre=22, Xander Schauffele=3, Sam Stevens=74
const MASTERS_ROSTER = [5, 14, 20, 22, 3, 74];
const TIEBREAK = 279;
const TARGET_DISPLAY_NAME = 'Brady Hogue';
