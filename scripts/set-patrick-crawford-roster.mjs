...
// Matt Fitzpatrick=20, Tommy Fleetwood=6, Michael Kim=59, Xander Schauffele=3, Sepp Straka=31, Cameron Young=23
const MASTERS_ROSTER = [20, 6, 59, 3, 31, 23];
const TIEBREAK = 270;
const TARGET_DISPLAY_NAME = 'Patrick Crawford';
