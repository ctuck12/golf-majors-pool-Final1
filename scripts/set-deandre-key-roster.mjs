...
// Jacob Bridgeman=60, Tommy Fleetwood=6, Jon Rahm=16, Aaron Rai=126, Xander Schauffele=3, Sepp Straka=31
const MASTERS_ROSTER = [60, 6, 16, 126, 3, 31];
const TIEBREAK = 275;
const TARGET_DISPLAY_NAME = 'DeAndre Key';
