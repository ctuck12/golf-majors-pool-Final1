...
// Corey Conners=33, Matt Fitzpatrick=20, Nicolai Hojgaard=38, Rory McIlroy=2, Patrick Reed=90, Justin Rose=61
const MASTERS_ROSTER = [33, 20, 38, 2, 90, 61];
const TIEBREAK = 276;
const TARGET_DISPLAY_NAME = 'Jay Ashby';
