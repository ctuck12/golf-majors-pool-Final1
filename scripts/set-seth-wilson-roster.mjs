...
// Akshay Bhatia=14, Corey Conners=33, Matt Fitzpatrick=20, Tommy Fleetwood=6, Brooks Koepka=9, Xander Schauffele=3
const MASTERS_ROSTER = [14, 33, 20, 6, 9, 3];
const TIEBREAK = 272;
const TARGET_DISPLAY_NAME = 'Seth Wilson';
