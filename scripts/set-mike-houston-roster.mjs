...
// Jacob Bridgeman=60, Bryson DeChambeau=15, Nicolai Hojgaard=38, Xander Schauffele=3, Gary Woodland=66, Cameron Young=23
const MASTERS_ROSTER = [60, 15, 38, 3, 66, 23];
const TIEBREAK = 278;
const TARGET_DISPLAY_NAME = 'Mike Houston';
