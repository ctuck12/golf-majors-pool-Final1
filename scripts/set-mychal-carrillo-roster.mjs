...
// Akshay Bhatia=14, Jason Day=27, Chris Gotterup=50, Jon Rahm=16, Patrick Reed=90, Cameron Young=23
const MASTERS_ROSTER = [14, 27, 50, 16, 90, 23];
const TIEBREAK = 279;
const TARGET_DISPLAY_NAME = 'Mychal Carrillo';
